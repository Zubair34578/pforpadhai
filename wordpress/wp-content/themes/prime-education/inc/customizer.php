...
function prime_education_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting('prime_education_sidebar_text_align', array(
    'default'           => 'left',
    'sanitize_callback' => 'sanitize_text_field',
    ));
    ...
    $wp_customize->add_control('sidebar_text_align_control', array(
        'label'    => __('Sidebar Heading Text Align', 'prime-education'),
        'section'  => 'prime_education_general_settings',
        'settings' => 'prime_education_sidebar_text_align',
        'type'     => 'select',
        'choices'  => array(
            'left'   => __('Left', 'prime-education'),
            'center' => __('Center', 'prime-education'),
        ),
    ));
